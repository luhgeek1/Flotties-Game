...
import { DEFAULT_PLAYERS, PlayerSetupCard } from "@/entities/players";
...
export function PlayersSetupScreen({ onContinue }: PlayersSetupScreenProps) {
  const activePlayers = DEFAULT_PLAYERS.filter(player => player.id);
    ...
    <SetupShell>
      ...
      >
        ...
        <div className="pt-6">
          ...
          >
            Продолжить {activePlayers.length}
